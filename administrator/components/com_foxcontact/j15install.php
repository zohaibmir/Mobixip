...
if (version_compare(JVERSION, '1.6.0', '<'))
	{
	JError::raiseWarning(500, 'This extension requires Joomla 1.6 or newer. See the <a href="forum/15-installation/77-joomla-compatibility-list.html" target="_blank">compatibility list</a>.');
	}
